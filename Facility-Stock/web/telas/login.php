...
<body>
    <header>
        ...
        <nav class="menu">
            ...
            <a href="../telas/quemSomos.html">Quem somos</a>
        ...
        <form method="get" action="../sistema/index.php" class="conteudos">
            ...
            <div>
                <p>
                    ...
                    <center>
                        <input type="email" name="id" id="id" required class="input"
                            data-validate="Valid e-mail is required: ex@abx.xyz">
                    </center>
                </p>
                <p>
                    <label for="nome"> SENHA </label><br>
                    <center>
                        <input type="password" name="nome" l size="50" maxlength="70" id="nome" required class="input"
